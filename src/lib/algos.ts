...
export const algos: Algo[] = [
  {
    ...
    docs_url: 'https://github.com/disarm-platform/fn-adaptive-sampling/blob/master/SPECS.md',
  ...
  },
  {
    ...
    docs_url: 'https://github.com/disarm-platform/fn-prevalence-predictor/blob/master/SPECS.md',
